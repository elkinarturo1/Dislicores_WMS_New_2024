...
namespace Dominio
{
    public class Upload_Transferencia_TBV_Desde_Requisicion_RQV : IUpload
    {
        public void procesar(EstructuraUploadModel objEnvio)
        {
            ...
            if (objEnvio.bitError == false)
            {
                try
                {
                    objEnvio.idDocumentoGT = 128207;
                    objEnvio.strDocumentoGT = "WMS_BOG_TRASNFERENCIA_TBV_DESDE_REQUISICION_RQV";
