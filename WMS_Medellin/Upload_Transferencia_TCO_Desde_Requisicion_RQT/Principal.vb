        ...
        Try
            ...
            If dsDatos.Tables.Count > 0 Then
                ...
                For Each registro As DataRow In dsDatos.Tables(0).Rows
                    ...
                    Try
                        objEnvio.tabla = "T_Upload_Transferencias_Desde_Requisicion_RQT_Rech"
                        ...
                        objEnvio.co_Transf_Salida = registro.Item("co_Transf_Salida").ToString
                        ...
                        Dim objImportacion As New Upload_Transferencia_TCO_Desde_Requisicion_RQT
