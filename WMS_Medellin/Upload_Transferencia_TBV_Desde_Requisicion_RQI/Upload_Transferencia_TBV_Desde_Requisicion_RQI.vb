...
Public Class Upload_Transferencia_TBV_Desde_Requisicion_RQI
    Private Sub Upload_Transferencia_TBV_Desde_Requisicion_RQI_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            If dsDatos.Tables.Count > 0 Then
                ...
                For Each registro As DataRow In dsDatos.Tables(0).Rows
                    ...
                    Try
                        objEnvio.tabla = "T_Upload_Transferencias_Desde_Requicision_RQI_Rech"
                        ...
                        Dim objImportacion As New Upload_Comprometer_RQI_Transferir_TBV
