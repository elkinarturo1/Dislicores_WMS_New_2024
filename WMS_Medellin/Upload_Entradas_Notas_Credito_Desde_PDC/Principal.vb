        ...
        Try
            ...
            If dsDatos.Tables.Count > 0 Then
                ...
                For Each registro As DataRow In dsDatos.Tables(0).Rows
                    ...
                    Try
                        objEnvio.tabla = "T_Upload_Notas_NV2_Desde_PDC_Rech"
                        ...
                        If dsDatos.Tables.Count > 3 Then
                            Dim drCxC() As DataRow = dsDatos.Tables(3).Select("paquete_Origen = '" & Trim(objEnvio.identificador1) & "'")
                            objEnvio.dtCxC = drCxC.CopyToDataTable()
                        End If


                        Dim AddThread1 As Threading.Thread
                        Dim objImportacion As New Upload_Entradas_Notas_NV2_Desde_PDC
