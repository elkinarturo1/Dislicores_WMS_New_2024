...
Namespace WSUNOEE
    ...
    Partial Public Class WSUNOEE
        ...
        Private SiesaCFDOperationCompleted As System.Threading.SendOrPostCallback
        
        Private ImportarXMLOperationCompleted As System.Threading.SendOrPostCallback
        
        Private InicializarVariablesImportacionOperationCompleted As System.Threading.SendOrPostCallback
        ...
        Public Sub New()
            MyBase.New
            Me.Url = Global.UPLOAD_Entrada_POP_Directas.My.MySettings.Default.UPLOAD_Entrada_POP_Directas_WSUNOEE_WSUNOEE
        ...
        '''<remarks/>
        Public Event SiesaCFDCompleted As SiesaCFDCompletedEventHandler
        
        '''<remarks/>
        Public Event ImportarXMLCompleted As ImportarXMLCompletedEventHandler
        
        '''<remarks/>
        Public Event InicializarVariablesImportacionCompleted As InicializarVariablesImportacionCompletedEventHandler
        ...
        '''<remarks/>
        <System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/SiesaCFD", RequestNamespace:="http://tempuri.org/", ResponseNamespace:="http://tempuri.org/", Use:=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle:=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)>  _
        Public Function SiesaCFD(ByVal pvintcia As Short, ByVal pvstrCo As String, ByVal pvstrTipoDocto As String, ByVal pvintConsecInicial As Long, ByVal pvintConsecFinal As Long, ByVal pvintConexion As String, ByVal pvintTimeOut As Long) As Object
            Dim results() As Object = Me.Invoke("SiesaCFD", New Object() {pvintcia, pvstrCo, pvstrTipoDocto, pvintConsecInicial, pvintConsecFinal, pvintConexion, pvintTimeOut})
            Return CType(results(0),Object)
        End Function
        
        '''<remarks/>
        Public Overloads Sub SiesaCFDAsync(ByVal pvintcia As Short, ByVal pvstrCo As String, ByVal pvstrTipoDocto As String, ByVal pvintConsecInicial As Long, ByVal pvintConsecFinal As Long, ByVal pvintConexion As String, ByVal pvintTimeOut As Long)
            Me.SiesaCFDAsync(pvintcia, pvstrCo, pvstrTipoDocto, pvintConsecInicial, pvintConsecFinal, pvintConexion, pvintTimeOut, Nothing)
        End Sub
        
        '''<remarks/>
        Public Overloads Sub SiesaCFDAsync(ByVal pvintcia As Short, ByVal pvstrCo As String, ByVal pvstrTipoDocto As String, ByVal pvintConsecInicial As Long, ByVal pvintConsecFinal As Long, ByVal pvintConexion As String, ByVal pvintTimeOut As Long, ByVal userState As Object)
            If (Me.SiesaCFDOperationCompleted Is Nothing) Then
                Me.SiesaCFDOperationCompleted = AddressOf Me.OnSiesaCFDOperationCompleted
            End If
            Me.InvokeAsync("SiesaCFD", New Object() {pvintcia, pvstrCo, pvstrTipoDocto, pvintConsecInicial, pvintConsecFinal, pvintConexion, pvintTimeOut}, Me.SiesaCFDOperationCompleted, userState)
        End Sub
        
        Private Sub OnSiesaCFDOperationCompleted(ByVal arg As Object)
            If (Not (Me.SiesaCFDCompletedEvent) Is Nothing) Then
                Dim invokeArgs As System.Web.Services.Protocols.InvokeCompletedEventArgs = CType(arg,System.Web.Services.Protocols.InvokeCompletedEventArgs)
                RaiseEvent SiesaCFDCompleted(Me, New SiesaCFDCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState))
            End If
        End Sub
        ...
        Public Sub InicializarVariablesImportacion()
            Me.Invoke("InicializarVariablesImportacion", New Object(-1) {})
        End Sub
        
        '''<remarks/>
        Public Overloads Sub InicializarVariablesImportacionAsync()
            Me.InicializarVariablesImportacionAsync(Nothing)
        End Sub
        
        '''<remarks/>
        Public Overloads Sub InicializarVariablesImportacionAsync(ByVal userState As Object)
            If (Me.InicializarVariablesImportacionOperationCompleted Is Nothing) Then
                Me.InicializarVariablesImportacionOperationCompleted = AddressOf Me.OnInicializarVariablesImportacionOperationCompleted
            End If
            Me.InvokeAsync("InicializarVariablesImportacion", New Object(-1) {}, Me.InicializarVariablesImportacionOperationCompleted, userState)
        End Sub
        
        Private Sub OnInicializarVariablesImportacionOperationCompleted(ByVal arg As Object)
            If (Not (Me.InicializarVariablesImportacionCompletedEvent) Is Nothing) Then
                Dim invokeArgs As System.Web.Services.Protocols.InvokeCompletedEventArgs = CType(arg,System.Web.Services.Protocols.InvokeCompletedEventArgs)
                RaiseEvent InicializarVariablesImportacionCompleted(Me, New System.ComponentModel.AsyncCompletedEventArgs(invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState))
            End If
        End Sub
    ...
    '''<remarks/>
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.8.4084.0")>  _
    Public Delegate Sub SiesaCFDCompletedEventHandler(ByVal sender As Object, ByVal e As SiesaCFDCompletedEventArgs)
    
    '''<remarks/>
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.8.4084.0"),  _
     System.Diagnostics.DebuggerStepThroughAttribute(),  _
     System.ComponentModel.DesignerCategoryAttribute("code")>  _
    Partial Public Class SiesaCFDCompletedEventArgs
        Inherits System.ComponentModel.AsyncCompletedEventArgs
    ...
    '''<remarks/>
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.8.4084.0")>  _
    Public Delegate Sub InicializarVariablesImportacionCompletedEventHandler(ByVal sender As Object, ByVal e As System.ComponentModel.AsyncCompletedEventArgs)
