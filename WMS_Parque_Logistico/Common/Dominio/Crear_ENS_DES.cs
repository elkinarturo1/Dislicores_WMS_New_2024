...
namespace Dominio
{
    public static class Crear_ENS_DES
    {
        ...
        public static void enviar_OEX(ref DataTable dt)
        {
            ...
            try
            {
                ...
                foreach (DataRow registro in dt.Rows)
                {
                    ...
                    //objHeader.DELIVERYDATE = DateTime.ParseExact(registro["DELIVERYDATE"].ToString(), "dd/MM/yyyy", CultureInfo.InvariantCulture);
