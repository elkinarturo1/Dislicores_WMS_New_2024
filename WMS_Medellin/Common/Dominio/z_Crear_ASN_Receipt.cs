...
namespace Dominio
{
    public static class z_Crear_ASN_Receipt
    {
        /// <summary>
        ...
        public static void ejecutarProceso(string vista_Oracle, string tabla_temporal, string sp_consultaPrincipal)
        {
